...
func (c FacadeConfig) Validate() error {
	...
	if c.CommandsEnabled() {
		if c.GenerateCommandsTopic == nil {
			err = go_errors.Join(err, errors.New("GenerateCommandsTopic is nil"))
		}
		if c.CommandsSubscriberConstructor == nil {
			err = go_errors.Join(err, errors.New("CommandsSubscriberConstructor is nil"))
		}
		if c.CommandsPublisher == nil {
			err = go_errors.Join(err, errors.New("CommandsPublisher is nil"))
		}
	}
	if c.EventsEnabled() {
		if c.GenerateEventsTopic == nil {
			err = go_errors.Join(err, errors.New("GenerateEventsTopic is nil"))
		}
		if c.EventsSubscriberConstructor == nil {
			err = go_errors.Join(err, errors.New("EventsSubscriberConstructor is nil"))
		}
		if c.EventsPublisher == nil {
			err = go_errors.Join(err, errors.New("EventsPublisher is nil"))
		}
	}

	if c.Router == nil {
		err = go_errors.Join(err, errors.New("Router is nil"))
	}
	if c.Logger == nil {
		err = go_errors.Join(err, errors.New("Logger is nil"))
	}
	if c.CommandEventMarshaler == nil {
		err = go_errors.Join(err, errors.New("CommandEventMarshaler is nil"))
	}
